...
class DesayunoBitacoraWidget extends StatefulWidget {
  const DesayunoBitacoraWidget({Key key, this.idPaciente1, this.nombrePaciente1, this.idTemp, this.listTemp, this.usuario}) : super(key: key);
...
class _DesayunoBitacoraWidgetState extends State<DesayunoBitacoraWidget> {
  ...
  void initState() {
    super.initState();
    if(flagResetDesayuno == true) {
      textoAlimento = "";
      flagResetDesayuno = false;
    }
  }
                      ...
                      onPressed: () async {
                        await Navigator.push(
                          ...
                          PageTransition(
                            ...
                            child: AlimentacionBitacoraWidget(idPaciente1: widget.idPaciente1, nombrePaciente1: widget.nombrePaciente1, idTemp: widget.idTemp, listTemp: widget.listTemp, usuario: widget.usuario),
                          ),
                        );
                      },
                      text: 'Registrar Otra',
