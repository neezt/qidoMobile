...
class CenaBitacoraWidget extends StatefulWidget {
  const CenaBitacoraWidget({Key key, this.idPaciente3, this.nombrePaciente3, this.idTemp, this.listTemp, this.usuario}) : super(key: key);

  final int idTemp;
  final List listTemp;
  final String idPaciente3,nombrePaciente3;
              ...
              onPressed: () async {
                await Navigator.push(
                  ...
                  PageTransition(
                    ...
                    child: RegistroBitacoraV2Widget(idPaciente: widget.idPaciente3, nombrePaciente: widget.nombrePaciente3, idTemp: widget.idTemp, listTemp: widget.listTemp, usuario: widget.usuario),
                  ),
                );
              },
            ),
                      ...
                      onPressed: () async {
                        await Navigator.push(
                          ...
                          PageTransition(
                            ...
                            child: AlimentacionBitacoraWidget(idPaciente1: widget.idPaciente3, nombrePaciente1: widget.nombrePaciente3, idTemp: widget.idTemp, listTemp: widget.listTemp, usuario: widget.usuario),
                          ),
                        );
                      },
                      text: 'Registrar Otra',
