...
class UploadFotoWidget extends StatefulWidget {
  const UploadFotoWidget({Key key}) : super(key: key);

  @override
  _UploadFotoWidgetState createState() => _UploadFotoWidgetState();
}
              ...
              child: Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    ...
                    var uploadFotoRecord;
                    await uploadFotoRecord.reference.update(usersUpdateData);
                    Navigator.pop(context);
                  },
                  text: 'Save Changes',
                  options: FFButtonOptions(
