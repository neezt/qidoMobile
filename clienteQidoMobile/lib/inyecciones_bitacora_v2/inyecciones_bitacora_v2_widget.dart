...
class _InyeccionesBitacoraV2WidgetState
    extends State<InyeccionesBitacoraV2Widget> with TickerProviderStateMixin {
  final animationsMap = {
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.cover,
                      image: Image.network(
                        'https://5.imimg.com/data5/VX/XJ/VV/IOS-1035039/product-jpeg-500x500.png',
                      ).image,
                    ),
                    boxShadow: [
                      BoxShadow(
